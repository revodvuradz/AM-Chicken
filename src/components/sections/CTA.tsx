        ...
        <section className="z-10 -mb-60 flex w-full max-w-screen-2xl flex-col px-4 md:px-8">
            <div className="flex w-full flex-col items-center justify-between gap-6 rounded-[18px] bg-white p-[30px] drop-shadow-xl md:flex-row">
                <div className="flex w-full grow flex-col items-start gap-[18px]">
                    <span className="ts-title-3 font-outfit font-semibold text-info-500">Kunjungi Kami</span>
                    <h1 className="font-outfit text-4xl font-bold leading-normal text-orange-300 md:text-[40px]">
                        Konsultasikan<span className="text-neutral-950"> Kebutuhan Anda</span>
                    </h1>
                    <p className="ts-regular-normal font-inter font-normal text-neutral-600">
                        Dapatkan ayam berkualitas terbaik sekarang juga! Kunjungi lokasi kami di Desa Gebangan, Krejengan, Probolinggo. Lihat lokasi kami di peta berikut untuk lebih mudah menemukan
                        kami. Kami siap menjalin kerjasama antar supplier, restoran, warung, dan UMKM support!
                    </p>
                    <div className="flex w-full max-w-[338px] flex-row justify-between gap-2 rounded-[34px] bg-green-100 px-5 py-3">
                        <div className="flex shrink-0 flex-row items-center gap-1">
                            ...
                            <span className="font-outfit text-xl font-normal leading-none text-green-500">089509028393</span>
                        </div>
                        <Button asLink size="small" href="https://wa.me/6289509028393" className="ts-xs-tight bg-gray-950 font-medium text-white md:ts-sm-tight">
                            Chat WhatsApp
                        </Button>
                    </div>
                </div>
